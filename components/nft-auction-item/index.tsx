    ...
    const renderer = ({ days, hours, minutes, seconds, completed }) => {
      if (completed) {
        ...
        if (hours > 0) {
          return (
            <span>
              {zeroPad(hours)} hours:{zeroPad(minutes)} mins
            </span>
          );
        }
        return (
          <span>
            {zeroPad(minutes)} mins:{zeroPad(seconds)} secs
          </span>
        );
      }
    };
        ...
        {isVisible && (
          ...
          >
            <VStack cursor="pointer">
              ...
              >
                <Image
                  src={'https://image.fraktal.io/?height=350&image=' + zimageURL}
                  width="100%"
                  height="100%"
                  objectFit="cover"
                  margin-left="auto"
